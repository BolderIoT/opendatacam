...
function docker_compose_setup() {
  ...
  wget -N https://raw.githubusercontent.com/BolderIoT/opendatacam/$VERSION/docker/run/$PLATFORM/docker-compose.yml
...
function k8s_setup() {
  ...
  wget -N https://raw.githubusercontent.com/BolderIoT/opendatacam/master/docker/run/$PLATFORM/kubernetes/0001-mongodb-deployment.yaml -P opendatacam
  wget -N https://raw.githubusercontent.com/BolderIoT/opendatacam/master/docker/run/$PLATFORM/kubernetes/0002-opendatacam-deployment.yaml -P opendatacam
...
if [ ! -f ./config.json ]; then
    ...
    wget -N https://raw.githubusercontent.com/BolderIoT/opendatacam/$VERSION/config.json
